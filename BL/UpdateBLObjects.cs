...
namespace BL
{
    public partial class BL : IBL.IBL
    {
        ...
        public void UpDateCustomerData(int id, string name = null, string newPhone = null)
        {
            ...
            List<ParcelDAL> ImSender = DalObj.returnParcelArray().ToList().FindAll(parcel => parcel.SenderId == id);
            List<ParcelDAL> ImTarget = DalObj.returnParcelArray().ToList().FindAll(parcel => parcel.TargetId == id);
