    ...
    public partial class BL 
    {
        public class ConvertToBL
        {
            ...
            public static CustomerBL ConvertToCustomrtBL(CustomerDAL customerDal)
            {
                ...
                List<ParcelDAL> ImTarget = DalObj.returnParcelArray().ToList().FindAll(parcel => parcel.TargetId == customerDal.Id);
            ...
            {
                ParcelBL parcelBL = new ParcelBL(parcelDal.SenderId, parcelDal.TargetId, (int)parcelDal.Weight, (int)parcelDal.Priority, parcelDal.Id, parcelDal.Requested, parcelDal.Scheduled, parcelDal.PickUp, parcelDal.Delivered);
                return parcelBL;
            }
